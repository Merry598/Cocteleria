...
function validarPago(){
  //alert("hilwe");
    var numid,nombre,sexo_rdo,numtel,correo,numtarjeta,fechavenc,codValid;
    ...
    if( document.fdatos.selecloc.selectedIndex==0){
  ...
  if( numtel==""){
    alert("Debe escribir el número de Telefono");
    document.fdatos.numtel.focus();
  return 0;
  }
    if( correo==""){
    ...
    if( fechavenc==""){
      ...
      document.fdatos.fechaVenc.focus();
    return 0;
  }
